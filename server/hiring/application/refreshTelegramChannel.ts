...
import { fetchHiringChannel, isLikelyCvPost } from '../../utils/hiringSources'
...
/**
 * Refresh one Telegram channel and fold it into the durable candidate snapshot.
 * Transport/parsing remains owned by hiringSources; this application service
 * owns only merge, retention, AI enrichment scheduling and persistence.
 */
