...
// Public-only sources. Facebook entries are candidate/mixed employment groups;
// Threads entries are anonymous Recent searches with explicit candidate intent.
