...
export default defineNuxtConfig({
    ...
    components: [
        {path: '~/components/services', pathPrefix: false},
    ...
    icon: {
        ...
        clientBundle: {
            ...
            icons: [
                ...
                'lucide:rotate-ccw',
                // Icons referenced through metadata/computed maps are not visible
                // to the template scanner, so every dynamic spec icon stays explicit.
                'lucide:tag',
                'lucide:user-round',
