...
export const countries: CountryEntity[] = [
    ...
    EU("countries.austria", "Austria", "high", {single: 1485, couple: 2225, perKid: 370}, {
        ...
        safety_need: 3,
        cost_low_need: -3,
        income_growth_need: 2,
        quality_high_need: 1,
}, numbeo(199.8, 123.2, 71.5, 78.9, 71.3, 9.9, 23.2, 20.4, 76.6)),
    EU("countries.belgium", "Belgium", "high", {single: 1415, couple: 2125, perKid: 355}, {climate_seasons: 3,
        cost_low_need: -2,
        income_growth_need: 3,
        quality_high_need: 3,
}, numbeo(175.2, 127.5, 50.8, 76.4, 68.6, 6.1, 32.7, 46.8, 86.5)),
    EU("countries.bulgaria", "Bulgaria", "mid", {single: 670, couple: 1005, perKid: 165}, {
        climate_seasons: 2,
        cost_low_need: 0,
        income_growth_need: 1,
        quality_high_need: 2,
    ...
    EU("countries.czechia", "Czechia", "mid", {single: 1215, couple: 1820, perKid: 305}, {climate_seasons: 3,
        cost_low_need: -2,
        income_growth_need: 1,
        quality_high_need: 0,
}, numbeo(175.3, 94.0, 73.6, 76.0, 53.0, 13.2, 28.7, 33.7, 77.7)),
    ...
    EU("countries.greece", "Greece", "mid", {single: 895, couple: 1340, perKid: 225}, {
        ...
        nature_water: 3,
        cost_low_need: -1,
        income_growth_need: 0,
        quality_high_need: 0,
}, numbeo(140.8, 65.4, 53.8, 58.9, 54.0, 12.5, 32.3, 49.2, 93.0)),
    EU("countries.hungary", "Hungary", "mid", {single: 800, couple: 1200, perKid: 200}, {climate_seasons: 3,
        cost_low_need: -1,
        income_growth_need: 1,
        quality_high_need: 0,
}, numbeo(147.6, 80.3, 66.5, 54.2, 46.9, 12.8, 35.4, 46.2, 79.8)),
    EU("countries.ireland", "Ireland", "very_high", {single: 2140, couple: 3205, perKid: 535}, {climate_seasons: 2,
        cost_low_need: -3,
        income_growth_need: 2,
        quality_high_need: 3,
}, numbeo(167.7, 119.0, 51.0, 51.2, 70.6, 6.9, 37.3, 34.7, 89.5)),
    ...
    EU("countries.latvia", "Latvia", "mid", {single: 835, couple: 1255, perKid: 210}, {climate_cold: 2,
        cost_low_need: -1,
        income_growth_need: 1,
        quality_high_need: 2,
}, numbeo(167.3, 79.1, 63.7, 63.6, 52.3, 8.9, 27.6, 29.1, 76.8)),
    EU("countries.lithuania", "Lithuania", "mid", {single: 890, couple: 1340, perKid: 225}, {climate_cold: 2,
        cost_low_need: -1,
        income_growth_need: 1,
        quality_high_need: 1,
}, numbeo(178.2, 89.7, 66.8, 75.4, 51.2, 11.2, 22.8, 25.2, 69.9)),
    EU("countries.luxembourg", "Luxembourg", "very_high", {single: 2270, couple: 3400, perKid: 565}, {safety_need: 3,
        cost_low_need: -3,
        income_growth_need: 3,
        quality_high_need: 2,
}, numbeo(211.9, 167.0, 66.8, 74.2, 78.0, 9.4, 26.4, 22.7, 82.6)),
    ...
    EU("countries.netherlands", "Netherlands", "very_high", {single: 1970, couple: 2955, perKid: 490}, {transport_public: 3, metro_midcity: 3,
        cost_low_need: -3,
        income_growth_need: 3,
        quality_high_need: 3,
}, numbeo(213.6, 136.6, 74.5, 81.5, 73.4, 7.5, 22.3, 20.9, 86.9)),
    ...
    EU("countries.slovakia", "Slovakia", "mid", {single: 1045, couple: 1570, perKid: 260}, {climate_seasons: 3,
        cost_low_need: -1,
        income_growth_need: 1,
        quality_high_need: 1,
}, numbeo(158.6, 80.1, 68.9, 58.2, 49.6, 12.6, 27.5, 36.8, 73.9)),
    ...
    COUNTRY(
        ...
        {lang_ru_need: 3, climate_cold: 3, country_large: 3, geo_continent: 3, cost_low_need: 1,
            income_growth_need: 0,
            quality_high_need: -2,
},
    ...
    COUNTRY(
        ...
        {climate_seasons: 3, cost_low_need: 2,
            income_growth_need: 0,
            quality_high_need: -2,
},
    ...
    COUNTRY(
        ...
        {lang_en_need: 3, transport_public: 3, stability_need: 3, quality_high_need: 2, society_international: 3,
            cost_low_need: -3,
            income_growth_need: 2,
},
    ...
    COUNTRY(
        ...
        {cost_low_need: 2, climate_warm: 2,
            income_growth_need: -1,
            quality_high_need: -3,
},
    ...
    COUNTRY(
        ...
        "low",
        {single: 485, couple: 725, perKid: 120},
        {climate_cold: 2, cost_low_need: 2, country_large: 2,
            income_growth_need: 0,
            quality_high_need: -2,
},
        {english: 0, russian: 2, noLocalLanguagePenalty: 2},
    ...
    COUNTRY(
        ...
        {cost_low_need: 2, nature_mountains_forest: 3,
            income_growth_need: -2,
            quality_high_need: -3,
},
        {english: 0, russian: 2, noLocalLanguagePenalty: 2},
    ...
    COUNTRY(
        ...
        {quality_high_need: 0, safety_need: 2, society_international: 2,
            cost_low_need: -3,
            income_growth_need: 2,
},
...
// --- Asia / ME (new) ---
    ...
    COUNTRY(
        ...
        {nature_mountains_forest: 3, climate_seasons: 2, cost_low_need: 3, rules_ok: -1, stability_need: -1,
            income_growth_need: -3,
            quality_high_need: -3,
},
        {english: 1, russian: 0, noLocalLanguagePenalty: 1},
    ...
    COUNTRY(
        ...
        {climate_warm: 3, climate_heat_ok: 2, cost_low_need: 3, rules_ok: -2, stability_need: -3, safety_need: -2,
            income_growth_need: 0,
            quality_high_need: 1,
},
        {english: 1, russian: 0, noLocalLanguagePenalty: 0},
    ...
    COUNTRY(
        ...
        {climate_seasons: 2, cost_low_need: 3, geo_continent: 3, rules_ok: -1, stability_need: -1,
            income_growth_need: 0,
            quality_high_need: 0,
},
        {english: 1, russian: 0, noLocalLanguagePenalty: 1},
