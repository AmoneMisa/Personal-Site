...
// Popup tab: the listing itself, or the same contact's other listings.
const modalTab = ref<"details" | "contact">("details");
const activeContactListingCount = computed(() => Number(active.value?.contactListingCount) || 0);
