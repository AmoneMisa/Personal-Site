...
.recent__chip { display: flex; flex-direction: column; gap: 2px; text-align: left; min-width: 0; padding: 10px 13px; border-radius: 9px; border: 1px solid var(--line); background: var(--bg-panel); cursor: pointer; transition: border-color 160ms ease, background-color 160ms ease; }
