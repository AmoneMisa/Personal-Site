...
.flat-card__photo::after { content: ""; position: absolute; z-index: 1; left: 0; right: 0; bottom: 0; height: 34%; pointer-events: none; background: linear-gradient(180deg, rgba(11,16,42,0) 0%, rgba(11,16,42,.18) 42%, rgba(11,16,42,.62) 78%, var(--bg-panel) 100%); }
...
@media (max-width: 760px) {
  ...
  .flat-card__photo::after { inset: 0 0 0 auto; width: 34%; height: auto; background: linear-gradient(90deg, rgba(11,16,42,0) 0%, rgba(11,16,42,.18) 42%, rgba(11,16,42,.62) 78%, var(--bg-panel) 100%); }
