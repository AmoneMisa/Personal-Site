...
@media(max-width:900px){.flat-stats__deal-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.flat-stats__metrics{grid-template-columns:repeat(2,minmax(0,1fr))}.flat-stats__geo-head{grid-template-columns:1fr}.flat-stats__geo-head> :deep(.search-source-tabs:first-of-type),.flat-stats__geo-head> :deep(.search-source-tabs:last-of-type){grid-column:auto;justify-self:stretch}.flat-stats__head{flex-wrap:wrap}}@media(max-width:640px){.flat-stats__body{grid-template-columns:1fr}.flat-stats__card_wide{grid-column:auto}.flat-stats__head{flex-direction:column}.flat-stats__segments{width:100%;overflow:auto}.flat-stats__segments button{flex:1;white-space:nowrap}.flat-stats__deal-grid,.flat-stats__geo-list,.flat-stats__metrics,.flat-stats__metrics_quality{grid-template-columns:1fr}.flat-stats__legend{align-items:flex-start;flex-direction:column}}
</style>