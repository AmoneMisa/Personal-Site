    ...
    sections: [
      ...
      },
      {
        ...
        list: [
          ...
          'Провайдеры ИИ для разбора текста и фото объявлений (через наш шлюз; в зависимости от настроек — Groq, Google Gemini, NVIDIA, Hugging Face, LLM7, OpenRouter, Mistral, Cloudflare Workers AI). Контакты удаляются из текста перед разбором, а при переводе заменяются метками и возвращаются в готовый перевод — провайдеры их не получают.',
      ...
      },
      {
        ...
        list: [
          ...
          'Технические журналы — перезаписываются по кругу, не более 30 МБ на сервис.',
    ...
    sections: [
      ...
      },
      {
        ...
        list: [
          ...
          'AI providers that analyse listing text and photos (through our gateway; depending on configuration: Groq, Google Gemini, NVIDIA, Hugging Face, LLM7, OpenRouter, Mistral, Cloudflare Workers AI). Contacts are removed from text before analysis, and in translations they are replaced by placeholders and restored afterwards, so providers never receive them.',
      ...
      },
      {
        ...
        list: [
          ...
          'Technical logs — overwritten in rotation, at most 30 MB per service.',
